...
<html lang="pt-BR">
  ...
  <body>
    <header>
      <div class="container">
        <a href="#" class="logo">
          <img src="<?php echo get_template_directory_uri() ?>/imgs/logo.svg" alt="Logo do Neon" />
        </a>
      ...
      <div class="container">
        <div class="text" data-aos="fade-right">
          ...
          <ul>
            <li>
              <div class="icon">
                <img
                  src="<?php echo get_template_directory_uri() ?>/imgs/icon-anuidade.svg"
            ...
            <li>
              <div class="icon">
                <img
                  src="<?php echo get_template_directory_uri() ?>/imgs/icon-conta-digital.svg"
                  alt="Ícone de um zero com uma linha divisória diagonal"
                />
              </div>
              <span
                >Conta digital<br />
            ...
            <li>
              <div class="icon">
                <img src="<?php echo get_template_directory_uri() ?>/imgs/icon-dinheiro.svg" alt="Ícone de um sifrão" />
              </div>
              <span
                >Seu dinheiro<br />
                rendendo mais</span
        ...
        <div class="area-image">
          ...
          <div class="image" data-aos="zoom-in">
            <img
              src="<?php echo get_template_directory_uri() ?>/imgs/card-neon-frnt.png"
              class="card-front"
              alt="Cartão de crédito visto de frente"
            />
            <img
              src="<?php echo get_template_directory_uri() ?>/imgs/card-neon-back.png"
              class="card-back"
              alt="Cartão de crédito visto de costas"
            />
            <img
              src="<?php echo get_template_directory_uri() ?>/imgs/circle-cards-neon.svg"
              class="circle"
              alt="Circulo branco com degradê para transparente"
            />
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="left-area">
          <div class="ilustra-mockup">
            <img src="<?php echo get_template_directory_uri() ?>/imgs/circle-mockup.svg" class="circle" data-aos="fade-left" alt="Circulo" />
            <img
              src="<?php echo get_template_directory_uri() ?>/imgs/mockup.svg"
              class="mockup"
              alt="Smartphone com varias opções"
              data-aos="flip-right"
            />
          </div>
          ...
          <div class="text" data-aos="fade-up">
            <div class="icon">
              <img src="<?php echo get_template_directory_uri() ?>/imgs/icon-neon.svg" alt="Icone de aplicativo Neon" />
            </div>
              ...
              <ul>
                <li>
                  <a href="#" target="_blank">
                    <img src="<?php echo get_template_directory_uri() ?>/imgs/apple-store.svg" alt="Apple Store" />
                  </a>
                </li>
                <li>
                  <a href="#" target="_blank">
                    <img src="<?php echo get_template_directory_uri() ?>/imgs/google-play.svg" alt="Google Play" />
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div class="main-text" data-aos="fade-left">
            ...
            <ul>
              <li>
                <div class="info">
                  <img
                    src="<?php echo get_template_directory_uri() ?>/imgs/icon-cartao-credito.svg"
                    class="icon"
                ...
                <img
                  src="<?php echo get_template_directory_uri() ?>/imgs/arrow-right.svg"
              ...
              <li>
                <div class="info">
                  <img
                    src="<?php echo get_template_directory_uri() ?>/imgs/icon-taxas.svg"
                    class="icon"
              ...
              <li>
                <div class="info">
                  <img
                    src="<?php echo get_template_directory_uri() ?>/imgs/icon-investimentos.svg"
                    alt="Ícone de um sifrão"
                  />
                  <div class="text">
          ...
          <div class="box-card" data-aos="fade-left">
            <div class="text">
              ...
              <div class="btns">
                ...
                <button class="btn-primary">Sou PJ</button>
              </div>
            </div>

            <img src="<?php echo get_template_directory_uri() ?>/imgs/card-front-pj.svg" class="image" alt="" />
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="card-testimony">
                <div class="user">
                  <strong>@marcogurka</strong>
                  <img src="<?php echo get_template_directory_uri() ?>/imgs/icon-twiiter.svg" alt="Twitter" />
                </div>
                <p>
    ...
    <section class="s-conta-digital">
      <div class="container">
        <div class="text" data-aos="fade-right">
          ...
          <ul>
            <li>
              <div class="icon">
                <img
                  src="<?php echo get_template_directory_uri() ?>/imgs/icon-cartao-internacional.svg"
                  alt="Cartão de crédito"
                />
              </div>
              <div class="info">
            ...
            <li>
              <div class="icon">
                <img
                  src="<?php echo get_template_directory_uri() ?>/imgs/icon-taxa-zero.svg"
                  alt="Número zero cortado diagonal"
                />
              </div>
              <div class="info">
            ...
            <li>
              <div class="icon">
                <img src="<?php echo get_template_directory_uri() ?>/imgs/icon-poupanca.svg" alt="Simbolo de sifrão" />
              </div>
              <div class="info">
        ...
        <div class="image">
          <img
            src="<?php echo get_template_directory_uri() ?>/imgs/mockup-01.svg"
            class="mockup-01"
            alt="Smartphone mostrando comprovante"
            data-aos="fade-up"
          />
          <img
            src="<?php echo get_template_directory_uri() ?>/imgs/mockup-02.png"
            class="mockup-02"
            alt="Smartphone mostrando tela de cadastro de aplicativo"
            data-aos="fade-down"
          />
          <img
            src="<?php echo get_template_directory_uri() ?>/imgs/circle-conta-digital.svg"
            class="circle"
            alt="Circulo com degradê"
            data-aos="zoom-in"
          />
        </div>
      </div>
    ...
    <footer>
      <div class="container">
        <div class="top">
          <img src="<?php echo get_template_directory_uri() ?>/imgs/logo.svg" alt="Neon" />
          <div class="share">
            ...
            <ul>
              <li>
                <a href="#" target="_blank">
                  <img src="<?php echo get_template_directory_uri() ?>/imgs/youtube.svg" alt="Youtube" />
                </a>
              </li>
              <li>
                <a href="#" target="_blank">
                  <img src="<?php echo get_template_directory_uri() ?>/imgs/linkedin.svg" alt="Linkedin" />
                </a>
              </li>
              <li>
                <a href="#" target="_blank">
                  <img src="<?php echo get_template_directory_uri() ?>/imgs/facebook.svg" alt="Facebook" />
                </a>
              </li>
              <li>
                <a href="#" target="_blank">
                  <img src="<?php echo get_template_directory_uri() ?>/imgs/instagram.svg" alt="Instagram" />
                </a>
              </li>
              <li>
                <a href="#" target="_blank">
                  <img src="<?php echo get_template_directory_uri() ?>/imgs/twitter-white.svg" alt="Twitter" />
                </a>
              </li>
            </ul>
          </div>
        ...
        <div class="main">
          ...
          <div class="btns">
            <button type="button">
              <img src="<?php echo get_template_directory_uri() ?>/imgs/envelope.svg" alt="Envelope" />
              <div class="info">
            ...
            <button type="button">
              <img src="<?php echo get_template_directory_uri() ?>/imgs/chat.svg" alt="Balão de conversa" />
              <div class="info">
